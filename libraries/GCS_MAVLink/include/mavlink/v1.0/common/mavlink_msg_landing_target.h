...
{
 float angle_x; ///< Angular offset(radians) of the object from the center of the image: x-axis
 float angle_y; ///< Angular offset(radians) of the object from the center of the image: x-axis
 float distance; ///< Distance to the object from the vehicle in meters
 ...
 * @param angle_x Angular offset(radians) of the object from the center of the image: x-axis
 * @param angle_y Angular offset(radians) of the object from the center of the image: x-axis
 * @param distance Distance to the object from the vehicle in meters
 ...
 *
 * @return Angular offset(radians) of the object from the center of the image: x-axis
 */
 ...
 *
 * @return Distance to the object from the vehicle in meters
 */
